...
wl_sat = np.array([442.7316, 492.441, 559.8538, 664.6208, 704.1223, 740.4838,
...
satfiles = glob.glob(opj(datadir, 'satellite/*GRSres.csv'))
for satfile in satfiles:
    ...
    fig, axs = plt.subplots(nrows=3, ncols=2, figsize=(15, 21))  # ncols=3, figsize=(30, 12))
    ...
    fig.savefig(os.path.join(figdir, 'Rrs_retieval_' + title + '.pdf'))
